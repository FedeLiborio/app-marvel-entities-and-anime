...
class RelatedContentComics extends StatelessWidget {

  const RelatedContentComics({Key key, @required this.futureComics}) : super(key: key);


  final Future<MarvelResponse<Comic>> futureComics;
